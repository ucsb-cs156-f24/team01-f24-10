...
public class UCSBOrganizationControllerTests extends ControllerTestCase {
    ...
    public void an_admin_user_can_post_a_new_commons() throws Exception {
            ...
            when(ucsbOrganizationRepository.save(eq(skydiving))).thenReturn(skydiving);
            ...
            // assert
            verify(ucsbOrganizationRepository, times(1)).save(skydiving);
            String expectedJson = mapper.writeValueAsString(skydiving);
