...
* Prod: <https://team01.dokku-10.cs.ucsb.edu>
* QA: <https://team01-qa.dokku-10.cs.ucsb.edu>

TODO: Fill in this table with correct information. 

| Table                     | Name         | Github Id |
|---------------------------|--------------|-----------|
| UCSBDiningCommonsMenuItem |Justin        |justinwu13 |
| UCSBOrganization          |Peter         |r0ckwav3   |
| RecommendationRequest     |Aneesh        |gargAneesh |
| MenuItemReview            |Derrick       |Dderricklee|
| HelpRequest               |Rajvir        |rranu      |
| Articles                  |Ajay          |AjayLiu    |
